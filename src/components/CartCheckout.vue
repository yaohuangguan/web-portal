            ...
            <table class="table product-table">
              ...
              <tbody v-for="(product, index) in getProductsInCart" :key="index">
                ...
                <tr id="animatedRow">
                  ...
                  <td v-if="hasProduct()">
                    <a title="add item" @click.prevent="addProductToCart(product)">
                      <i class="fas fa-plus-circle fa-2x"></i>
                    </a>
                    <a title="Remove item" @click.prevent="removeFromCart(product)">
            ...
            <div class="float-right">
              ...
              <div colspan="3" class="text-right">
                <router-link to="/checkout">
                  <button type="button" class="btn btn-b btn-rounded waves-effect">Complete purchase</button>
                </router-link>
              </div>
            </div>
          </div>
